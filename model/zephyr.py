...
class Zephyr(nn.Module):
    ...
    """
    def __init__(self, vocab_size, n_classes, num_conv_layers=4, kernel_sizes=[3, 3, 3, 3], dilations=[1, 2, 4, 6], hidden_dim=256, dropout=0.3, n_heads=4,
    ...
    def forward(self, x, seq_lens):
        ...
        :return: Tensor size (batch, n_classes), detached hidden states size (batch, n_blocks, seq_len, hidden_dim)
        """
        ...
        x, attention_weights = self.att_pooling(x, x_mask.squeeze(1))
