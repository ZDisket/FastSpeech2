...
from utils.tools import to_device, log, synth_one_sample, synth_one_sample_st
from model import FastSpeech3Loss, SturmLoss
from dataset import Dataset


device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

def evaluate_st(model, step, configs, logger=None, vocoder=None, epoch=0):
    ...
    message = ("Validation Step {}, Total Loss: {:.4f}, Mel Loss: {:.4f}, Gate Loss: {:.4f},  Forward Sum Loss: {:.4f},  Decoder Token Loss: {:.4f}").format(
